...
module.exports = Object.freeze({
    ...
    streetTypes: ["вулиця", "провулок", "площа", "перехрестя", "проспект", "майдан", "вул.", "міст"],
    generalStreetArticleTitleRegex: /^(вулиця|провулок|площа|перехрестя|проспект|майдан|вул.|міст) ([-'\u0400-\u04FF\w\s]+)$/ig,
    streetArticleTitleRegex: /(вулиця|провулок|площа|перехрестя|проспект|майдан|міст) ([-'\u0400-\u04FF\w\s]+) \(([-'\u0400-\u04FF\w\s]+)\)/ig,
