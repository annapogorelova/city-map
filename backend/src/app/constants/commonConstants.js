...
module.exports = Object.freeze({
    ...
    streetTypes: ["вулиця", "провулок", "площа", "перехрестя", "проспект", "майдан", "вул.", "міст", "пасаж", "проїзд"],
    generalStreetArticleTitleRegex: /^(вулиця|провулок|площа|перехрестя|проспект|майдан|вул.|міст|пасаж|проїзд) ([-'\u0400-\u04FF\w\s]+)$/ig,
    streetArticleTitleRegex: /(вулиця|провулок|площа|перехрестя|проспект|майдан|міст|пасаж|проїзд) ([-'\u0400-\u04FF\w\s]+) \(([-'\u0400-\u04FF\w\s]+)\)/ig,
